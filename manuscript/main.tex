...
\begin{document}
	...
	\section{Participants Selection and Coordination}\label{sec:app:participants_select}
	...
	\begin{figure}[t]
		\centering
		\includegraphics[width=\columnwidth]{llm_human_judgement_by_dataset_detection.png}
		\caption{Percentage of times survey participants decided to intervene in discussions by dataset. Some LLMs always over-intervene, while other under-intervene in most domains, except for the traditional forum-structured dataset.}
		\label{fig:detection-by-domain}
	\end{figure}
	
	Why do we observe this discrepancy between domains? It could be caused by some dataset-specific linguistic markers or structure caused by the \ac{wt} dataset; indeed, \ac{wt} is the only dataset considered in this study specifically containing escalating discussions. An alternative 
