...
Defined as an intervention whose purpose is to encourage a specific behavior. For example, a moderator may ask people to participate, ask a person to elaborate etc. Positive reinforcement is not related to positive speech; the moderator may be strict or even rude when attempting to encourage specific behaviors (e.g., “I will not tolerate any further discussion on this topic. It's been decided and we're moving on.”).
...
Remember that the role of the facilitator is supportive, not dominant. While intervention is sometimes necessary, be cautious. Arbitrary or frequent intervention degrades the user experience.
